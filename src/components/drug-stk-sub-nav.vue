	...
	<div class=" flex justify-between w-full">
		<ul class=" flex items-start">
			...
			<li
				...
				:key="i + '22d2'"
				class="ml-8 pb-1 cursor-pointer"
				:class="activeTab === h.payload ? 'active__header' : ''"
		...
		<div>
			<button @click="paginate('next')" :disabled="disabled">Next</button> |
			<button @click="paginate('prev')" :disabled="disabled">Prev</button>
		</div>
	</div>
</template>
